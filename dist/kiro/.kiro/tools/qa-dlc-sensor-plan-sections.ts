#!/usr/bin/env bun
// qa-dlc-sensor-plan-sections.ts — verifies gherkin_plan.md carries the required
...
//
//   bun qa-dlc-sensor-plan-sections.ts --stage <slug> --file-path <path>
//
...
function main(): void {
  const { filePath } = parseArgs(process.argv.slice(2), "qa-dlc-sensor-plan-sections");
