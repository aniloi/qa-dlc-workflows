// qa-dlc-lib.ts — shared, zero-dependency helpers for the QA-DLC engine, graph
...
// The workflow's runtime doc root. Kept as aidlc-docs/ to match QA-DLC v1
...
/** Per-stage sensor detail-file directory: aidlc-docs/.qa-dlc-sensors/<slug>/. */
export function sensorsDir(projectRoot: string, stageSlug: string): string {
  return join(docsRoot(projectRoot), ".qa-dlc-sensors", stageSlug);
}
