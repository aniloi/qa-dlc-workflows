// qa-dlc-sensor-schema.ts — sensor manifest schema (capability descriptor only).
// Consumed by qa-dlc-graph.ts (compile) and validated per manifest. Pull
...
import { parseFrontmatter, scalarField } from "./qa-dlc-lib.ts";
