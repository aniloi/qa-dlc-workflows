#!/usr/bin/env bun
// qa-dlc-audit-logger.ts — PostToolUse hook. Emits ARTIFACT_CREATED /
...
// determinism that replaces QA-DLC v1's "MANDATORY: log in audit.md" prose —
...
import { appendAuditEntry, ensureAudit } from "../tools/qa-dlc-audit.ts";
import {
  auditPath,
  docsRoot,
  errorMessage,
