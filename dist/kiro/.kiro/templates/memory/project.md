...
> loop may append here when a correction is project-scoped.
...
<!-- The component tags this project uses (matches existing feature files), e.g.
@account @deposit @auth @schema -->

## Project-specific conventions

<!-- Anything that overrides team defaults for this repo only. -->
