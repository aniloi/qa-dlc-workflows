// qadlc-stage-schema.ts — the stage-file frontmatter contract. Sibling of
// qadlc-scope-schema.ts and qadlc-sensor-schema.ts. Consumed by
// qadlc-graph.ts (compile). Hand-rolled, zero-dep — reuses the frontmatter
// primitives from qadlc-lib.ts.
//
...
import { listField, parseFrontmatter, scalarField } from "./qadlc-lib.ts";
