#!/usr/bin/env bun
// qadlc-sensor-gherkin-lint.ts — structural lint of one .feature file.
//
//   bun qadlc-sensor-gherkin-lint.ts --stage <slug> --file-path <path>
//
...
function main(): void {
  const { filePath } = parseArgs(process.argv.slice(2), "qadlc-sensor-gherkin-lint");
