...
id: step-existence
kind: deterministic
command: bun {{HARNESS_DIR}}/tools/qa-dlc-sensor-step-existence.ts
...
`aidlc-docs/.qa-dlc/step-catalog.json` (written by the Step Inventory stage;
...
`aidlc-docs/.qa-dlc-sensors/<stage>/step-existence-<ts>.md` listing each step
